...
const emailSignupGoogleTemplate = (email, password) => `
   <div style="width: 100%; max-width:600px; margin: 0 auto">
        ...
        <div style="width: 100%;margin: auto; font-family: Roboto, sans-serif; border: 1px solid #f0f0f0; text-align: left">
            <div style="padding: 20px;">
                ...
                <p style="margin: 0; margin-bottom: 30px; color: #294661; font-size: 16px; font-weight: 300;">Xin chúc mừng, bạn đã đăng ký tài khoản thành công.</p>
...
module.exports = emailSignupGoogleTemplate;
